...
const r = "bayerDitherFunctions", d = `float bayerDither2(vec2 _P) {return mod(2.0*_P.y+_P.x+1.0,4.0);}
...
const a = "shadowMapPixelShader", S = `#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
e.ShadersStore[a] || (e.ShadersStore[a] = S);
const M = { name: a, shader: S };
export {
  M as shadowMapPixelShader
};
