import { q as yn, L as Sn, e as G } from "./index-5c1585cf.js";
const ln = 4, X = 4, an = 1, C = 2, xn = 8, H = 65536, j = H >> 3, En = 16, T = 14, L = (1 << En) + 1, V = 1 << T, d = V - 1, q = 59, sn = 63, vn = 2 + sn - q;
var U;
(function(n) {
...
function zn(n, t) {
  ...
  for (; s; ) {
    ...
    if (!o)
      ...
      const i = $(n.buffer, t), a = m(n, t), u = Fn(n, t, i, a);
...
function jn(n) {
  ...
  qn(n.array, t, e, f, l, c);
  for (let p = 0; p < n.channels; ++p) {
    const w = s[p];
    for (let y = 0; y < s[p].size; ++y)
      Kn(l, w.start + y, w.nx, w.size, w.ny, w.nx * w.size, u);
  }
  $n(a, l, c);
  let E = 0;
