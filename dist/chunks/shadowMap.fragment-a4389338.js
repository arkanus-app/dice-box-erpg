...
const r = "bayerDitherFunctions", S = `float bayerDither2(vec2 _P) {return mod(2.0*_P.y+_P.x+1.0,4.0);}
...
const t = "shadowMapFragmentExtraDeclaration", o = `#if SM_FLOAT==0
...
const i = "shadowMapFragment", n = `float depthSM=vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
const a = "shadowMapPixelShader", d = `#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
e.ShadersStore[a] || (e.ShadersStore[a] = d);
const c = { name: a, shader: d };
export {
  c as shadowMapPixelShader
};
