import { r as e } from "./index-9624f4fa.js";
import "./logDepthDeclaration-9a95ee81.js";
import "./helperFunctions-11d45b8e.js";
import "./meshUboDeclaration-00d8eda6.js";
const i = "decalFragmentDeclaration", P = `#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;
e.IncludesShadersStore[i] || (e.IncludesShadersStore[i] = P);
const t = "defaultFragmentDeclaration", x = `uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
const r = "prePassDeclaration", X = `#ifdef PREPASS
...
const a = "oitDeclaration", F = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;
e.IncludesShadersStore[a] || (e.IncludesShadersStore[a] = F);
const n = "lightFragmentDeclaration", R = `#ifdef LIGHT{X}
...
const l = "lightUboDeclaration", N = `#ifdef LIGHT{X}
uniform Light{X}
...
#endif
`;
e.IncludesShadersStore[l] || (e.IncludesShadersStore[l] = N);
const f = "ltcHelperFunctions", M = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
e.IncludesShadersStore[f] || (e.IncludesShadersStore[f] = M);
const s = "lightsFragmentFunctions", O = `struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;
e.IncludesShadersStore[s] || (e.IncludesShadersStore[s] = O);
const d = "shadowsFragmentFunctions", y = `#ifdef SHADOWS
...
const c = "samplerFragmentDeclaration", b = `#ifdef _DEFINENAME_
...
#endif
`;
e.IncludesShadersStore[c] || (e.IncludesShadersStore[c] = b);
const h = "fresnelFunction", _ = `#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;
e.IncludesShadersStore[h] || (e.IncludesShadersStore[h] = _);
const v = "reflectionFunction", U = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;
e.IncludesShadersStore[v] || (e.IncludesShadersStore[v] = U);
const u = "imageProcessingDeclaration", W = `#ifdef EXPOSURE
...
#endif
`;
e.IncludesShadersStore[u] || (e.IncludesShadersStore[u] = W);
const p = "imageProcessingFunctions", z = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
const m = "bumpFragmentMainFunctions", H = `#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
const S = "bumpFragmentFunctions", G = `#if defined(BUMP)
...
#endif
`;
e.IncludesShadersStore[S] || (e.IncludesShadersStore[S] = G);
const g = "fogFragmentDeclaration", V = `#ifdef FOG
...
#endif
`;
e.IncludesShadersStore[g] || (e.IncludesShadersStore[g] = V);
const E = "bumpFragment", B = `vec2 uvOffset=vec2(0.0,0.0);
...
const C = "decalFragment", k = `#ifdef DECAL
#ifdef GAMMADECAL
...
const D = "depthPrePass", Y = `#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;
e.IncludesShadersStore[D] || (e.IncludesShadersStore[D] = Y);
const w = "lightFragment", $ = `#ifdef LIGHT{X}
...
#endif
`;
e.IncludesShadersStore[w] || (e.IncludesShadersStore[w] = $);
const I = "logDepthFragment", q = `#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;
e.IncludesShadersStore[I] || (e.IncludesShadersStore[I] = q);
const L = "fogFragment", Z = `#ifdef FOG
...
#endif
`;
e.IncludesShadersStore[L] || (e.IncludesShadersStore[L] = Z);
const A = "oitFragment", Q = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
const o = "defaultPixelShader", T = `#define CUSTOM_FRAGMENT_EXTENSION
...
`;
e.ShadersStore[o] || (e.ShadersStore[o] = T);
const oe = { name: o, shader: T };
export {
  oe as defaultPixelShader
};
