import { q as I, e as d, E as m, u as S, v as b } from "./index-e294dacb.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./index-e294dacb.js").then((r) => r.X).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-fc1f62f4.js").then(({ passPixelShader: n }) => {
        if (!e) {
