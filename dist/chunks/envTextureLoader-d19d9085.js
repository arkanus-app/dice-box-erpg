import { H as C, L as U, I as D, e as B, J as z, P as G, x as V, V as m } from "./index-73e06c00.js";
import "./dumpTools-841450e0.js";
import { C as H } from "./cubemapToSphericalPolynomial-bb87e782.js";
  ...
  get: function() {
    if (this._texture) {
      ...
      if (this._texture.isReady)
        return this._texture._sphericalPolynomialPromise || (this._texture._sphericalPolynomialPromise = H.ConvertCubeMapTextureToSphericalPolynomial(this), this._texture._sphericalPolynomialPromise === null ? this._texture._sphericalPolynomialComputed = !0 : this._texture._sphericalPolynomialPromise.then((e) => {
...
async function O(e, a, r, n = R) {
  ...
  let L = 0;
  if (i)
    t.isWebGPU ? (L = 1, await import("./rgbdDecode.fragment-d1ee6f8e.js")) : await import("./rgbdDecode.fragment-e9d759c7.js"), f = new G("rgbdDecode", "rgbdDecode", null, null, 1, null, 3, t, !1, void 0, e.type, void 0, null, !1, void 0, L), e._isRGBD = !1, e.invertY = !1, p = t.createRenderTargetCubeTexture(e.width, {
    ...
    for (let u = 0; u < 3; u++) {
      const w = 1 - u / 2, d = _, I = (o - 1) * c + _, M = d + (I - d) * w, b = Math.round(Math.min(Math.max(M, 0), I)), v = new D(
        t,
        2
  ...
  for (let s = 0; s < a.length; s++)
    for (let c = 0; c < 6; c++) {
      ...
      if (t._features.forceBitmapOverHTMLImageElement)
        ...
        const d = new Image();
        d.src = g, w = new Promise((I, M) => {
          d.onload = () => {
            S(d, t, i, f, g, c, s, l, T, p, e).then(() => I()).catch((b) => {
              M(b);
            });
          }, d.onerror = (b) => {
            M(b);
