import { C as I, T as d, E as m, f as S, g as b } from "./offscreenCanvas.worker-c48b6cd9.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./offscreenCanvas.worker-c48b6cd9.js").then(function(r) {
      return r.t;
    }).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-cd6faa9f.js").then(({ passPixelShader: n }) => {
        if (!e) {
