import { J as e } from "./Dice-f63fdd4d.js";
import "./logDepthDeclaration-9e658b50.js";
import "./helperFunctions-5b029d3b.js";
import "./clipPlaneFragment-04214308.js";
import "./fogFragment-407fd845.js";
import "./meshUboDeclaration-572902d3.js";
...
const a = "oitDeclaration", L = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;
e.IncludesShadersStoreWGSL[a] || (e.IncludesShadersStoreWGSL[a] = L);
const o = "lightUboDeclaration", I = `#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
const i = "ltcHelperFunctions", E = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
const f = "lightsFragmentFunctions", D = `struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
const n = "shadowsFragmentFunctions", A = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
const s = "samplerFragmentDeclaration", P = `#ifdef _DEFINENAME_
...
const l = "fresnelFunction", X = `#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;
e.IncludesShadersStoreWGSL[l] || (e.IncludesShadersStoreWGSL[l] = X);
const d = "reflectionFunction", M = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;
e.IncludesShadersStoreWGSL[d] || (e.IncludesShadersStoreWGSL[d] = M);
const c = "imageProcessingDeclaration", N = `#ifdef EXPOSURE
...
const v = "imageProcessingFunctions", _ = `#if TONEMAPPING==3
...
e.IncludesShadersStoreWGSL[v] || (e.IncludesShadersStoreWGSL[v] = _);
const u = "bumpFragmentMainFunctions", y = `#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
const p = "bumpFragmentFunctions", R = `#if defined(BUMP)
...
#endif
`;
e.IncludesShadersStoreWGSL[p] || (e.IncludesShadersStoreWGSL[p] = R);
const h = "bumpFragment", F = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;
e.IncludesShadersStoreWGSL[h] || (e.IncludesShadersStoreWGSL[h] = F);
const m = "decalFragment", O = `#ifdef DECAL
...
#endif
`;
e.IncludesShadersStoreWGSL[m] || (e.IncludesShadersStoreWGSL[m] = O);
const S = "depthPrePass", b = `#ifdef DEPTHPREPASS
...
const x = "logDepthFragment", z = `#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;
e.IncludesShadersStoreWGSL[x] || (e.IncludesShadersStoreWGSL[x] = z);
const w = "oitFragment", U = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;
e.IncludesShadersStoreWGSL[w] || (e.IncludesShadersStoreWGSL[w] = U);
const r = "defaultPixelShader", C = `#include<defaultUboDeclaration>
...
`;
e.ShadersStoreWGSL[r] || (e.ShadersStoreWGSL[r] = C);
const $ = { name: r, shader: C };
export {
  $ as defaultPixelShaderWGSL
};
