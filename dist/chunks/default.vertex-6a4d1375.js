...
import { s as b, m as G } from "./meshUboDeclaration-b9ddce93.js";
import { d as C, m as z, l as B } from "./logDepthDeclaration-56faca72.js";
import { h as w } from "./helperFunctions-e372c494.js";
import { b as H, a as Y, d as $, m as j, c as k, e as Q, f as K, i as Z, g as q, h as J, j as ee } from "./clipPlaneVertex-564f63aa.js";
import { i as te } from "./instancesDeclaration-e1bd2918.js";
const i = "uvAttributeDeclaration", V = `#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;
e.IncludesShadersStoreWGSL[i] || (e.IncludesShadersStoreWGSL[i] = V);
const ie = { name: i, shader: V }, r = "prePassVertexDeclaration", S = `#ifdef PREPASS
...
const re = { name: r, shader: S }, a = "samplerVertexDeclaration", N = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;
e.IncludesShadersStoreWGSL[a] || (e.IncludesShadersStoreWGSL[a] = N);
const ae = { name: a, shader: N }, n = "bumpVertexDeclaration", T = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
const ne = { name: n, shader: T }, f = "fogVertexDeclaration", O = `#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;
e.IncludesShadersStoreWGSL[f] || (e.IncludesShadersStoreWGSL[f] = O);
const fe = { name: f, shader: O }, d = "lightVxFragmentDeclaration", h = `#ifdef LIGHT{X}
...
const de = { name: d, shader: h }, o = "lightVxUboDeclaration", A = `#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
`;
e.IncludesShadersStoreWGSL[o] || (e.IncludesShadersStoreWGSL[o] = A);
const oe = { name: o, shader: A }, s = "vertexPullingDeclaration", U = `#ifdef USE_VERTEX_PULLING
...
const se = { name: s, shader: U }, v = "vertexPullingVertex", L = `#ifdef USE_VERTEX_PULLING
...
#endif
`;
e.IncludesShadersStoreWGSL[v] || (e.IncludesShadersStoreWGSL[v] = L);
const ve = { name: v, shader: L }, u = "prePassVertex", g = `#ifdef PREPASS_DEPTH
...
#endif
`;
e.IncludesShadersStoreWGSL[u] || (e.IncludesShadersStoreWGSL[u] = g);
const ue = { name: u, shader: g }, l = "uvVariableDeclaration", y = `#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;
e.IncludesShadersStoreWGSL[l] || (e.IncludesShadersStoreWGSL[l] = y);
const le = { name: l, shader: y }, c = "samplerVertexImplementation", M = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
const ce = { name: c, shader: M }, p = "bumpVertex", P = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
const pe = { name: p, shader: P }, _ = "fogVertex", R = `#ifdef FOG
#ifdef SCENE_UBO
...
#endif
`;
e.IncludesShadersStoreWGSL[_] || (e.IncludesShadersStoreWGSL[_] = R);
const _e = { name: _, shader: R }, m = "shadowsVertex", D = `#ifdef SHADOWS
...
const me = { name: m, shader: D }, x = "vertexColorMixing", X = `#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
`;
e.IncludesShadersStoreWGSL[x] || (e.IncludesShadersStoreWGSL[x] = X);
const xe = { name: x, shader: X }, E = "logDepthVertex", W = `#ifdef LOGARITHMICDEPTH
vertexOutputs.vFragmentDepth=1.0+vertexOutputs.position.w;vertexOutputs.position.z=log2(max(0.000001,vertexOutputs.vFragmentDepth))*uniforms.logarithmicDepthConstant;
#endif
`;
e.IncludesShadersStoreWGSL[E] || (e.IncludesShadersStoreWGSL[E] = W);
const Ee = { name: E, shader: W }, I = "defaultVertexShader", F = `#include<defaultUboDeclaration>
...
`;
e.ShadersStoreWGSL[I] || (e.ShadersStoreWGSL[I] = F);
const Ie = [b, G, C, ie, w, H, Y, te, re, z, ae, ne, $, fe, de, oe, j, k, B, se, ve, Q, K, Z, q, J, ue, le, ce, pe, ee, _e, me, xe, Ee];
for (const t of Ie)
  e.IncludesShadersStoreWGSL[t.name] || (e.IncludesShadersStoreWGSL[t.name] = t.shader);
const Ae = { name: I, shader: F };
export {
  Ae as defaultVertexShaderWGSL
};
