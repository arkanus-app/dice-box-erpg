import { v as I, e as d, E as m, z as S, F as b } from "./index-4ecddc6d.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./index-4ecddc6d.js").then((r) => r.a1).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-97d36bdf.js").then(({ passPixelShader: n }) => {
        if (!e) {
