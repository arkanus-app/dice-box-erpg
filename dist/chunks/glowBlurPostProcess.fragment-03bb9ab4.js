import { o as r } from "./index-ba22601e.js";
const e = "glowBlurPostProcessPixelShader", t = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform screenSize: vec2f;uniform direction: vec2f;uniform blurWidth: f32;fn getLuminance(color: vec3f)->f32
...
export {
  o as glowBlurPostProcessPixelShaderWGSL
};
