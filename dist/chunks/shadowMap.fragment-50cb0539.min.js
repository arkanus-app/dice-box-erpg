import{J as e}from"./Dice-6806d227.min.js";import"./packingFunctions-814e32c9.min.js";import"./clipPlaneFragment-fe349806.min.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=n);const d={name:a,shader:n};export{d as shadowMapPixelShaderWGSL};
