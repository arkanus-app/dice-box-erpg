...
import "./packingFunctions-59054852.js";
...
const t = "shadowMapFragmentExtraDeclaration", S = `#if SM_FLOAT==0
...
const n = "shadowMapFragment", s = `var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
const a = "shadowMapPixelShader", i = `#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
e.ShadersStoreWGSL[a] || (e.ShadersStoreWGSL[a] = i);
const u = { name: a, shader: i };
export {
  u as shadowMapPixelShaderWGSL
};
