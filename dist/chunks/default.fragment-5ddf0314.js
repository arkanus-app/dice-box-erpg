...
import "./logDepthDeclaration-b33aa41d.js";
import "./helperFunctions-16d5d395.js";
import "./clipPlaneFragment-80141bfc.js";
import "./meshUboDeclaration-6e9c6584.js";
const t = "prePassDeclaration", I = `#ifdef PREPASS
...
const a = "oitDeclaration", E = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;
e.IncludesShadersStoreWGSL[a] || (e.IncludesShadersStoreWGSL[a] = E);
const o = "lightUboDeclaration", D = `#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
const i = "ltcHelperFunctions", A = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
const f = "lightsFragmentFunctions", P = `struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;
e.IncludesShadersStoreWGSL[f] || (e.IncludesShadersStoreWGSL[f] = P);
const n = "shadowsFragmentFunctions", X = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
const s = "samplerFragmentDeclaration", M = `#ifdef _DEFINENAME_
...
const l = "fresnelFunction", N = `#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;
e.IncludesShadersStoreWGSL[l] || (e.IncludesShadersStoreWGSL[l] = N);
const d = "reflectionFunction", F = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
const c = "imageProcessingDeclaration", _ = `#ifdef EXPOSURE
...
#endif
`;
e.IncludesShadersStoreWGSL[c] || (e.IncludesShadersStoreWGSL[c] = _);
const v = "imageProcessingFunctions", y = `#if TONEMAPPING==3
...
const u = "bumpFragmentMainFunctions", R = `#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;
e.IncludesShadersStoreWGSL[u] || (e.IncludesShadersStoreWGSL[u] = R);
const p = "bumpFragmentFunctions", O = `#if defined(BUMP)
...
const h = "fogFragmentDeclaration", b = `#ifdef FOG
...
#endif
`;
e.IncludesShadersStoreWGSL[h] || (e.IncludesShadersStoreWGSL[h] = b);
const m = "bumpFragment", W = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;
e.IncludesShadersStoreWGSL[m] || (e.IncludesShadersStoreWGSL[m] = W);
const S = "decalFragment", z = `#ifdef DECAL
...
const g = "depthPrePass", U = `#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;
e.IncludesShadersStoreWGSL[g] || (e.IncludesShadersStoreWGSL[g] = U);
const x = "lightFragment", G = `#ifdef LIGHT{X}
...
#endif
`;
e.IncludesShadersStoreWGSL[x] || (e.IncludesShadersStoreWGSL[x] = G);
const w = "logDepthFragment", V = `#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;
e.IncludesShadersStoreWGSL[w] || (e.IncludesShadersStoreWGSL[w] = V);
const C = "fogFragment", H = `#ifdef FOG
...
#endif
`;
e.IncludesShadersStoreWGSL[C] || (e.IncludesShadersStoreWGSL[C] = H);
const T = "oitFragment", B = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;
e.IncludesShadersStoreWGSL[T] || (e.IncludesShadersStoreWGSL[T] = B);
const r = "defaultPixelShader", L = `#include<defaultUboDeclaration>
...
`;
e.ShadersStoreWGSL[r] || (e.ShadersStoreWGSL[r] = L);
const Q = { name: r, shader: L };
export {
  Q as defaultPixelShaderWGSL
};
