...
const e = "glowMapMergePixelShader", a = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;
#ifdef EMISSIVE
...
`;
r.ShadersStoreWGSL[e] || (r.ShadersStoreWGSL[e] = a);
const o = { name: e, shader: a };
export {
  o as glowMapMergePixelShaderWGSL
};
