import { r as i } from "./index-f87975a8.js";
import "./helperFunctions-9d380831.js";
import "./clipPlaneFragment-4e7e7e32.js";
const e = "glowMapGenerationPixelShader", a = `#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;
i.ShadersStoreWGSL[e] || (i.ShadersStoreWGSL[e] = a);
const l = { name: e, shader: a };
export {
  l as glowMapGenerationPixelShaderWGSL
};
