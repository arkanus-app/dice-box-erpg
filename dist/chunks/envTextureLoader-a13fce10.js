import { L as U, av as D, $ as B, aw as z, V as d } from "./Dice-f63fdd4d.js";
import { P as G, S as V } from "./postProcess-1c1e23eb.js";
import { B as I } from "./texture-1ebdc842.js";
import { C as k } from "./passPostProcess-54bc8c21.js";
import "./dumpTools-d75efd6d.js";
I.prototype.forceSphericalPolynomialsRecompute = function() {
...
Object.defineProperty(I.prototype, "sphericalPolynomial", {
  get: function() {
    if (this._texture) {
...
async function O(e, a, r, n = R) {
  ...
  let L = 0;
  if (i)
    t.isWebGPU ? (L = 1, await import("./rgbdDecode.fragment-3f41bb3f.js")) : await import("./rgbdDecode.fragment-a37da204.js"), f = new G("rgbdDecode", "rgbdDecode", null, null, 1, null, 3, t, !1, void 0, e.type, void 0, null, !1, void 0, L), e._isRGBD = !1, e.invertY = !1, p = t.createRenderTargetCubeTexture(e.width, {
    ...
    for (let u = 0; u < 3; u++) {
      const w = 1 - u / 2, m = _, M = (o - 1) * c + _, C = m + (M - m) * w, b = Math.round(Math.min(Math.max(C, 0), M)), v = new D(
        t,
        2
  ...
  for (let s = 0; s < a.length; s++)
    for (let c = 0; c < 6; c++) {
      ...
      if (t._features.forceBitmapOverHTMLImageElement)
        w = t.createImageBitmap(u, { premultiplyAlpha: "none" }).then((m) => S(m, t, i, f, g, c, s, l, T, p, e));
      else {
        const m = new Image();
        m.src = g, w = new Promise((M, C) => {
          m.onload = () => {
            S(m, t, i, f, g, c, s, l, T, p, e).then(() => M()).catch((b) => {
              C(b);
            });
          }, m.onerror = (b) => {
            C(b);
...
function W(e, a) {
  ...
  if (!r)
    return;
  const n = new V();
  d.FromArrayToRef(r.x, 0, n.x), d.FromArrayToRef(r.y, 0, n.y), d.FromArrayToRef(r.z, 0, n.z), d.FromArrayToRef(r.xx, 0, n.xx), d.FromArrayToRef(r.yy, 0, n.yy), d.FromArrayToRef(r.zz, 0, n.zz), d.FromArrayToRef(r.yz, 0, n.yz), d.FromArrayToRef(r.zx, 0, n.zx), d.FromArrayToRef(r.xy, 0, n.xy), e._sphericalPolynomial = n;
}
class Z {
  constructor() {
