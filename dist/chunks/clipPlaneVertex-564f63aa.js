...
#endif
`;
e.IncludesShadersStoreWGSL[t] || (e.IncludesShadersStoreWGSL[t] = l);
const A = { name: t, shader: l }, r = "bakedVertexAnimationDeclaration", I = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
const _ = { name: r, shader: I }, n = "clipPlaneVertexDeclaration", c = `#ifdef CLIPPLANE
...
#endif
`;
e.IncludesShadersStoreWGSL[n] || (e.IncludesShadersStoreWGSL[n] = c);
const V = { name: n, shader: c }, i = "morphTargetsVertexGlobalDeclaration", p = `#ifdef MORPHTARGETS
...
const L = { name: i, shader: p }, a = "morphTargetsVertexDeclaration", x = `#ifdef MORPHTARGETS
...
const h = { name: a, shader: x }, f = "morphTargetsVertexGlobal", E = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
...
const P = { name: f, shader: E }, d = "morphTargetsVertex", T = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
const g = { name: d, shader: T }, s = "instancesVertex", v = `#ifdef INSTANCES
...
#endif
`;
e.IncludesShadersStoreWGSL[s] || (e.IncludesShadersStoreWGSL[s] = v);
const O = { name: s, shader: v }, o = "bonesVertex", S = `#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
const W = { name: o, shader: S }, m = "bakedVertexAnimation", N = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;
e.IncludesShadersStoreWGSL[m] || (e.IncludesShadersStoreWGSL[m] = N);
const C = { name: m, shader: N }, u = "clipPlaneVertex", R = `#ifdef CLIPPLANE
