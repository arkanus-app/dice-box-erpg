import { s as I, e as d, E as m, t as S, u as b } from "./index-f87975a8.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./index-f87975a8.js").then((r) => r.a1).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-9cc6c365.js").then(({ passPixelShader: n }) => {
        if (!e) {
