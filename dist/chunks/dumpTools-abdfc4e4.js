import { q as I, e as d, E as m, r as S, s as b } from "./index-5c1585cf.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./index-5c1585cf.js").then((r) => r.$).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-3c18e91f.js").then(({ passPixelShader: n }) => {
        if (!e) {
