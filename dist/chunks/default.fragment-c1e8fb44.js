...
import { s as Z, m as Q } from "./meshUboDeclaration-b9ddce93.js";
import { d as J, m as K, l as ee } from "./logDepthDeclaration-56faca72.js";
import { h as re } from "./helperFunctions-e372c494.js";
import { c as te, a as ae } from "./clipPlaneFragment-d28f74f5.js";
const t = "prePassDeclaration", D = `#ifdef PREPASS
...
#endif
`;
e.IncludesShadersStoreWGSL[t] || (e.IncludesShadersStoreWGSL[t] = D);
const ie = { name: t, shader: D }, a = "oitDeclaration", A = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;
e.IncludesShadersStoreWGSL[a] || (e.IncludesShadersStoreWGSL[a] = A);
const oe = { name: a, shader: A }, i = "lightUboDeclaration", P = `#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
`;
e.IncludesShadersStoreWGSL[i] || (e.IncludesShadersStoreWGSL[i] = P);
const fe = { name: i, shader: P }, o = "ltcHelperFunctions", X = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
const ne = { name: o, shader: X }, f = "clusteredLightingFunctions", R = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
const se = { name: f, shader: R }, n = "lightsFragmentFunctions", _ = `struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
const le = { name: n, shader: _ }, s = "shadowsFragmentFunctions", y = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;
e.IncludesShadersStoreWGSL[s] || (e.IncludesShadersStoreWGSL[s] = y);
const de = { name: s, shader: y }, l = "samplerFragmentDeclaration", F = `#ifdef _DEFINENAME_
...
const ce = { name: l, shader: F }, d = "fresnelFunction", N = `#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;
e.IncludesShadersStoreWGSL[d] || (e.IncludesShadersStoreWGSL[d] = N);
const ve = { name: d, shader: N }, c = "reflectionFunction", M = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;
e.IncludesShadersStoreWGSL[c] || (e.IncludesShadersStoreWGSL[c] = M);
const ue = { name: c, shader: M }, v = "imageProcessingDeclaration", O = `#ifdef EXPOSURE
...
#endif
`;
e.IncludesShadersStoreWGSL[v] || (e.IncludesShadersStoreWGSL[v] = O);
const pe = { name: v, shader: O }, u = "imageProcessingFunctions", b = `#if TONEMAPPING==3
...
e.IncludesShadersStoreWGSL[u] || (e.IncludesShadersStoreWGSL[u] = b);
const he = { name: u, shader: b }, p = "textureRepetitionFunctions", W = `#if TEXTURE_REPETITION_MODE>0
...
`;
e.IncludesShadersStoreWGSL[p] || (e.IncludesShadersStoreWGSL[p] = W);
const me = { name: p, shader: W }, h = "bumpFragmentMainFunctions", z = `#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;
e.IncludesShadersStoreWGSL[h] || (e.IncludesShadersStoreWGSL[h] = z);
const Se = { name: h, shader: z }, m = "bumpFragmentFunctions", U = `#if defined(BUMP)
...
#endif
`;
e.IncludesShadersStoreWGSL[m] || (e.IncludesShadersStoreWGSL[m] = U);
const ge = { name: m, shader: U }, S = "fogFragmentDeclaration", G = `#ifdef FOG
...
const xe = { name: S, shader: G }, g = "bumpFragment", H = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;
e.IncludesShadersStoreWGSL[g] || (e.IncludesShadersStoreWGSL[g] = H);
const Te = { name: g, shader: H }, x = "decalFragment", V = `#ifdef DECAL
...
#endif
`;
e.IncludesShadersStoreWGSL[x] || (e.IncludesShadersStoreWGSL[x] = V);
const Le = { name: x, shader: V }, T = "depthPrePass", k = `#ifdef DEPTHPREPASS
...
#endif
`;
e.IncludesShadersStoreWGSL[T] || (e.IncludesShadersStoreWGSL[T] = k);
const Ce = { name: T, shader: k }, L = "lightFragment", B = `#ifdef LIGHT{X}
...
#endif
`;
e.IncludesShadersStoreWGSL[L] || (e.IncludesShadersStoreWGSL[L] = B);
const we = { name: L, shader: B }, C = "logDepthFragment", Y = `#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;
e.IncludesShadersStoreWGSL[C] || (e.IncludesShadersStoreWGSL[C] = Y);
const Ee = { name: C, shader: Y }, w = "fogFragment", $ = `#ifdef FOG
...
#endif
`;
e.IncludesShadersStoreWGSL[w] || (e.IncludesShadersStoreWGSL[w] = $);
const Ie = { name: w, shader: $ }, E = "oitFragment", q = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;
e.IncludesShadersStoreWGSL[E] || (e.IncludesShadersStoreWGSL[E] = q);
const De = { name: E, shader: q }, I = "defaultPixelShader", j = `#include<defaultUboDeclaration>
...
`;
e.ShadersStoreWGSL[I] || (e.ShadersStoreWGSL[I] = j);
const Ae = [Z, Q, J, ie, oe, K, re, fe, ne, se, le, de, ce, ve, ue, pe, he, me, Se, ge, te, ee, xe, ae, Te, Le, Ce, we, Ee, Ie, De];
for (const r of Ae)
  e.IncludesShadersStoreWGSL[r.name] || (e.IncludesShadersStoreWGSL[r.name] = r.shader);
const Fe = { name: I, shader: j };
export {
  Fe as defaultPixelShaderWGSL
};
