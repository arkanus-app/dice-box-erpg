...
import { p as l } from "./packingFunctions-0cd5b868.js";
import { c, a as h } from "./clipPlaneFragment-276bba01.js";
const r = "bayerDitherFunctions", n = `float bayerDither2(vec2 _P) {return mod(2.0*_P.y+_P.x+1.0,4.0);}
...
const f = { name: r, shader: n }, t = "shadowMapFragmentExtraDeclaration", o = `#if SM_FLOAT==0
...
const p = { name: t, shader: o }, i = "shadowMapFragment", S = `float depthSM=vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
return;`;
e.IncludesShadersStore[i] || (e.IncludesShadersStore[i] = S);
const M = { name: i, shader: S }, d = "shadowMapPixelShader", s = `#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
e.ShadersStore[d] || (e.ShadersStore[d] = s);
const m = [l, f, p, c, h, M];
for (const a of m)
  e.IncludesShadersStore[a.name] || (e.IncludesShadersStore[a.name] = a.shader);
const E = { name: d, shader: s };
export {
  E as shadowMapPixelShader
};
