...
import { b as a, a as n, m as f, c as o, d as s, e as d, f as u, i as v, g as c, h as p, j as x } from "./clipPlaneVertex-564f63aa.js";
import { i as l } from "./instancesDeclaration-e1bd2918.js";
...
const m = [a, n, f, o, s, l, d, u, v, c, p, x];
for (const i of m)
  e.IncludesShadersStoreWGSL[i.name] || (e.IncludesShadersStoreWGSL[i.name] = i.shader);
const I = { name: t, shader: r };
export {
  I as glowMapGenerationVertexShaderWGSL
};
