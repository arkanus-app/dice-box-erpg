...
const n = "clipPlaneVertexDeclaration", x = `#ifdef CLIPPLANE
...
const i = "morphTargetsVertexGlobalDeclaration", c = `#ifdef MORPHTARGETS
...
const a = "morphTargetsVertexDeclaration", p = `#ifdef MORPHTARGETS
...
#endif
`;
e.IncludesShadersStoreWGSL[a] || (e.IncludesShadersStoreWGSL[a] = p);
const f = "morphTargetsVertexGlobal", T = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
...
const s = "morphTargetsVertex", E = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
const d = "instancesVertex", S = `#ifdef INSTANCES
...
#endif
`;
e.IncludesShadersStoreWGSL[d] || (e.IncludesShadersStoreWGSL[d] = S);
const o = "bonesVertex", v = `#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;
e.IncludesShadersStoreWGSL[o] || (e.IncludesShadersStoreWGSL[o] = v);
const m = "bakedVertexAnimation", N = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
const u = "clipPlaneVertex", A = `#ifdef CLIPPLANE
