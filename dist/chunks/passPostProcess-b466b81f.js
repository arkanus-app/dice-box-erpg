import { F as v, p as D, V as r, G as Y, u as S, H as N, z as U, J as k, R as G, N as q, U as B, q as Z, P as H, W as X } from "./index-c6dc4169.js";
class A {
  constructor(e, a, n, t) {
    ...
    for (let P = 0; P < 6; P++) {
      ...
      for (let h = 0; h < e.size; h++) {
        ...
        for (let w = 0; w < e.size; w++) {
          ...
          isNaN(l) && (l = 0), isNaN(o) && (o = 0), isNaN(c) && (c = 0), e.type === 0 && (l /= 255, o /= 255, c /= 255), e.gammaSpace && (l = Math.pow(S(l), N), o = Math.pow(S(o), N), c = Math.pow(S(c), N));
          ...
          const W = new Y(l, o, c);
          a.addLight(M, W, L), n += L, p += t;
        }
        m += i;
      }
    }
    const T = 4 * Math.PI * 6 / 6 / n;
    return a.scaleInPlace(T), a.convertIncidentRadianceToIrradiance(), a.convertIrradianceToLambertianRadiance(), D.FromHarmonics(a);
  }
}
x._FileFaces = [
...
x.MAX_HDRI_VALUE = 4096;
x.PRESERVE_CLAMPED_COLORS = !1;
class _ extends U {
  _gatherImports(e, a) {
    e ? (this._webGPUReady = !0, a.push(Promise.all([import("./pass.fragment-e7c3c822.js")]))) : a.push(Promise.all([import("./pass.fragment-f824e15d.js")])), super._gatherImports(e, a);
  }
  /**
...
class b extends U {
  _gatherImports(e, a) {
    e ? (this._webGPUReady = !0, a.push(Promise.all([import("./passCube.fragment-3052952f.js")]))) : a.push(Promise.all([import("./passCube.fragment-daa1eb43.js")])), super._gatherImports(e, a);
  }
  /**
...
class y extends H {
  ...
  static _Parse(e, a, n, t) {
    return X.Parse(() => new y(e.name, e.options, a, e.renderTargetSamplingMode, e._engine, e.reusable), e, n, t);
  }
}
G("BABYLON.PassPostProcess", y);
class z extends H {
  /**
   * Gets or sets the cube face to display.
   *  * 0 is +X
   ...
   */
  static _Parse(e, a, n, t) {
    return X.Parse(() => new z(e.name, e.options, a, e.renderTargetSamplingMode, e._engine, e.reusable), e, n, t);
  }
}
q([
  B()
], z.prototype, "face", null);
Z._RescalePostProcessFactory = (R) => new y("rescale", 1, null, 2, R, !1, 0);
export {
  x as C
};
