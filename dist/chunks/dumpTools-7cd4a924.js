import { s as I, e as d, E as m, t as S, u as b } from "./index-9624f4fa.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./index-9624f4fa.js").then((r) => r.a1).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-7a96fee5.js").then(({ passPixelShader: n }) => {
        if (!e) {
