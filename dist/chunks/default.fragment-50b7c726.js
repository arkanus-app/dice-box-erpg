...
import { s as te, m as oe } from "./meshUboDeclaration-88016d5c.js";
import { d as re, m as ae, l as ne } from "./logDepthDeclaration-ce2a3e7c.js";
import { h as le } from "./helperFunctions-d48976dd.js";
import { c as se, a as fe } from "./clipPlaneFragment-276bba01.js";
const t = "decalFragmentDeclaration", R = `#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;
e.IncludesShadersStore[t] || (e.IncludesShadersStore[t] = R);
const de = { name: t, shader: R }, o = "defaultFragmentDeclaration", F = `uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
const ce = { name: o, shader: F }, r = "prePassDeclaration", X = `#ifdef PREPASS
...
const ve = { name: r, shader: X }, a = "oitDeclaration", N = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
const he = { name: a, shader: N }, n = "lightFragmentDeclaration", M = `#ifdef LIGHT{X}
...
const ue = { name: n, shader: M }, l = "lightUboDeclaration", O = `#ifdef LIGHT{X}
uniform Light{X}
...
e.IncludesShadersStore[s] || (e.IncludesShadersStore[s] = _);
const me = { name: s, shader: _ }, f = "clusteredLightingFunctions", y = `struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
const ge = { name: f, shader: y }, d = "lightsFragmentFunctions", b = `struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;
e.IncludesShadersStore[d] || (e.IncludesShadersStore[d] = b);
const Se = { name: d, shader: b }, c = "shadowsFragmentFunctions", U = `#ifdef SHADOWS
...
const Ee = { name: c, shader: U }, v = "samplerFragmentDeclaration", W = `#ifdef _DEFINENAME_
...
const Ce = { name: v, shader: W }, h = "fresnelFunction", H = `#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;
e.IncludesShadersStore[h] || (e.IncludesShadersStore[h] = H);
const De = { name: h, shader: H }, u = "reflectionFunction", z = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
const Te = { name: u, shader: z }, p = "imageProcessingDeclaration", G = `#ifdef EXPOSURE
...
#endif
`;
e.IncludesShadersStore[p] || (e.IncludesShadersStore[p] = G);
const Le = { name: p, shader: G }, m = "imageProcessingFunctions", V = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;
e.IncludesShadersStore[m] || (e.IncludesShadersStore[m] = V);
const Ie = { name: m, shader: V }, g = "textureRepetitionFunctions", B = `#if TEXTURE_REPETITION_MODE>0
...
`;
e.IncludesShadersStore[g] || (e.IncludesShadersStore[g] = B);
const we = { name: g, shader: B }, S = "bumpFragmentMainFunctions", k = `#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
const xe = { name: S, shader: k }, E = "bumpFragmentFunctions", Y = `#if defined(BUMP)
...
#endif
`;
e.IncludesShadersStore[E] || (e.IncludesShadersStore[E] = Y);
const Ae = { name: E, shader: Y }, C = "fogFragmentDeclaration", $ = `#ifdef FOG
...
#endif
`;
e.IncludesShadersStore[C] || (e.IncludesShadersStore[C] = $);
const Pe = { name: C, shader: $ }, D = "bumpFragment", Z = `vec2 uvOffset=vec2(0.0,0.0);
...
const Re = { name: D, shader: Z }, T = "decalFragment", q = `#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;
e.IncludesShadersStore[T] || (e.IncludesShadersStore[T] = q);
const Fe = { name: T, shader: q }, L = "depthPrePass", j = `#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;
e.IncludesShadersStore[L] || (e.IncludesShadersStore[L] = j);
const Xe = { name: L, shader: j }, I = "lightFragment", Q = `#ifdef LIGHT{X}
...
#endif
`;
e.IncludesShadersStore[I] || (e.IncludesShadersStore[I] = Q);
const Ne = { name: I, shader: Q }, w = "logDepthFragment", J = `#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;
e.IncludesShadersStore[w] || (e.IncludesShadersStore[w] = J);
const Me = { name: w, shader: J }, x = "fogFragment", K = `#ifdef FOG
...
#endif
`;
e.IncludesShadersStore[x] || (e.IncludesShadersStore[x] = K);
const Oe = { name: x, shader: K }, A = "oitFragment", ee = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;
e.IncludesShadersStore[A] || (e.IncludesShadersStore[A] = ee);
const _e = { name: A, shader: ee }, P = "defaultPixelShader", ie = `#define CUSTOM_FRAGMENT_EXTENSION
...
`;
e.ShadersStore[P] || (e.ShadersStore[P] = ie);
const ye = [de, ce, te, oe, re, ve, he, ae, le, ue, pe, me, ge, Se, Ee, Ce, De, Te, Le, Ie, we, xe, Ae, se, ne, Pe, fe, Re, Fe, Xe, Ne, Me, Oe, _e];
for (const i of ye)
  e.IncludesShadersStore[i.name] || (e.IncludesShadersStore[i.name] = i.shader);
const Ge = { name: P, shader: ie };
export {
  Ge as defaultPixelShader
};
