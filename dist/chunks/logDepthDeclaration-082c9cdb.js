...
const o = "defaultUboDeclaration", a = `layout(std140,column_major) uniform;uniform Material
...
const t = "mainUVVaryingDeclaration", r = `#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;
e.IncludesShadersStore[t] || (e.IncludesShadersStore[t] = r);
const i = "logDepthDeclaration", c = `#ifdef LOGARITHMICDEPTH
