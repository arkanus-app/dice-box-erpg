import { P as C, L as U, I as D, e as B, U as z, W as G, F as V, V as m } from "./index-d880ba66.js";
import "./dumpTools-2b77acad.js";
import { C as k } from "./cubemapToSphericalPolynomial-cc871af9.js";
...
function $(e, a, r) {
  ...
  if (i) {
    const f = N(a, r);
    o.push(Y(e, f, i.size, r.imageType));
  }
...
async function O(e, a, r, n = R) {
  ...
  let L = 0;
  if (i)
    t.isWebGPU ? (L = 1, await import("./rgbdDecode.fragment-f5b6afbb.js")) : await import("./rgbdDecode.fragment-45de2358.js"), f = new G("rgbdDecode", "rgbdDecode", null, null, 1, null, 3, t, !1, void 0, e.type, void 0, null, !1, void 0, L), e._isRGBD = !1, e.invertY = !1, p = t.createRenderTargetCubeTexture(e.width, {
