import { e as S, a as I } from "./postProcess-1c1e23eb.js";
import { aS as b, $ as d, E as m } from "./Dice-f63fdd4d.js";
...
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./postProcess-1c1e23eb.js").then((r) => r.t).then(({ ThinEngine: r }) => {
      var f;
      ...
      const p = new S(e);
      import("./pass.fragment-e1cf47c0.js").then(({ passPixelShader: n }) => {
        if (!e) {
