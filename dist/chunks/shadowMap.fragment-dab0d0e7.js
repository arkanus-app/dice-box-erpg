...
import { p as d } from "./packingFunctions-f019c25b.js";
import { c as p, a as c } from "./clipPlaneFragment-d28f74f5.js";
const r = "bayerDitherFunctions", f = `fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;
e.IncludesShadersStoreWGSL[r] || (e.IncludesShadersStoreWGSL[r] = f);
const h = { name: r, shader: f }, n = "shadowMapFragmentExtraDeclaration", S = `#if SM_FLOAT==0
...
const u = { name: n, shader: S }, t = "shadowMapFragment", s = `var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;
e.IncludesShadersStoreWGSL[t] || (e.IncludesShadersStoreWGSL[t] = s);
const l = { name: t, shader: s }, i = "shadowMapPixelShader", o = `#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
e.ShadersStoreWGSL[i] || (e.ShadersStoreWGSL[i] = o);
const M = [d, h, u, p, c, l];
for (const a of M)
  e.IncludesShadersStoreWGSL[a.name] || (e.IncludesShadersStoreWGSL[a.name] = a.shader);
const E = { name: i, shader: o };
export {
  E as shadowMapPixelShaderWGSL
};
