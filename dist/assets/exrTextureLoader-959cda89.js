import { C as yn, c as Sn, T as G } from "./offscreenCanvas.worker-5e1bcfa9.js";
const ln = 4, X = 4, an = 1, R = 2, xn = 8, H = 65536, j = H >> 3, En = 16, T = 14, F = (1 << En) + 1, V = 1 << T, d = V - 1, K = 59, sn = 63, vn = 2 + sn - K;
var U;
(function(n) {
...
function Kn(n, t, e, l, r, c) {
  ...
  const f = new Array(F), E = new Array(V);
  Zn(E);
  const I = l - (e.value - o);
  ...
  for (a >>= 1, u = a, a >>= 1; a >= 1; ) {
    ...
    for (; f <= E; f += p) {
      ...
      for (; x <= W; x += y) {
        ...
        if (o) {
          let S = N(n[x + t], n[g + t]);
          h = S.a, A = S.b, S = N(n[O + t], n[k + t]), v = S.a, L = S.b, S = N(h, v), n[x + t] = S.a, n[O + t] = S.b, S = N(A, L), n[g + t] = S.a, n[k + t] = S.b;
        } else {
          let S = C(n[x + t], n[g + t]);
          h = S.a, A = S.b, S = C(n[O + t], n[k + t]), v = S.a, L = S.b, S = C(h, v), n[x + t] = S.a, n[O + t] = S.b, S = C(A, L), n[g + t] = S.a, n[k + t] = S.b;
        }
      }
      if (e & a) {
        const O = x + I;
        let g;
        o ? g = N(n[x + t], n[O + t]) : g = C(n[x + t], n[O + t]), h = g.a, n[O + t] = g.b, n[x + t] = h;
      }
    }
    if (r & a) {
      let x = f;
