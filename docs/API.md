...
Esta referência descreve a API pública de `@erpg/dice3dview` 2.2.2. A biblioteca é destinada ao navegador: a criação exige DOM; a inicialização do renderer exige WebGL.
