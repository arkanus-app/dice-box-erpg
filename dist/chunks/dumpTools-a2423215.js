import { q as I, e as d, E as m, u as S, v as b } from "./index-726652ee.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./index-726652ee.js").then((r) => r.X).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-3adc6846.js").then(({ passPixelShader: n }) => {
        if (!e) {
