import { z as V, F as H, V as n, G as D, s as P, H as _ } from "./index-d880ba66.js";
class A {
  constructor(e, i, w, c) {
...
class T {
  ...
  static ConvertCubeMapTextureToSphericalPolynomial(e) {
    ...
    const E = e.readPixels(4, void 0, void 0, !1), R = e.readPixels(5, void 0, void 0, !1), x = e.gammaSpace, z = 5;
    let M = 0;
    return (e.textureType == 1 || e.textureType == 2) && (M = 1), new Promise((p) => {
      Promise.all([c, w, S, a, E, R]).then(([F, r, t, f, d, m]) => {
        const u = {
          size: i,
          right: r,
          left: F,
    ...
    for (let h = 0; h < 6; h++) {
      ...
      for (let f = 0; f < e.size; f++) {
        ...
        for (let m = 0; m < e.size; m++) {
          ...
          u.normalize();
          const y = this._AreaElement(d - a, r - a) - this._AreaElement(d - a, r + a) - this._AreaElement(d + a, r - a) + this._AreaElement(d + a, r + a);
          ...
          const v = new D(s, o, l);
          i.addLight(u, v, y), w += y, d += c;
        }
        r += S;
      }
    }
    const M = 4 * Math.PI * 6 / 6 / w;
    return i.scaleInPlace(M), i.convertIncidentRadianceToIrradiance(), i.convertIrradianceToLambertianRadiance(), H.FromHarmonics(i);
  }
}
T._FileFaces = [
