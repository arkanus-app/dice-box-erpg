...
function B(t, e, s, r, i, n) {
  i > 0 ? (i = D(1, i - (128 + 8)), t[n + 0] = e * i, t[n + 1] = s * i, t[n + 2] = r * i) : (t[n + 0] = 0, t[n + 1] = 0, t[n + 2] = 0);
}
function g(t, e) {
  let s = "", r;
...
function H(t, e) {
  ...
  const p = new ArrayBuffer(r * 4), w = new Uint8Array(p), A = new ArrayBuffer(e.width * e.height * 4 * 3), u = new Float32Array(A);
  for (; s > 0; ) {
    ...
    for (c = 0; c < r; c++)
      i = w[c], n = w[c + r], o = w[c + 2 * r], h = w[c + 3 * r], B(u, i, n, o, h, (e.height - s) * r * 3 + c * 3);
    s--;
  }
  return u;
}
function F(t, e) {
  ...
  for (; s > 0; ) {
    for (l = 0; l < e.width; l++)
      i = t[a++], n = t[a++], o = t[a++], h = t[a++], B(d, i, n, o, h, (e.height - s) * r * 3 + l * 3);
    s--;
  }
  return d;
}
class M {
   ...
   */
  loadData(e, s, r) {
    const i = new Uint8Array(e.buffer, e.byteOffset, e.byteLength), n = b(i), o = m(i, n), h = n.width * n.height, l = new Float32Array(h * 4);
    for (let a = 0; a < h; a += 1)
