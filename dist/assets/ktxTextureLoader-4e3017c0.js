import { c as n, T as l } from "./offscreenCanvas.worker-5e1bcfa9.js";
class _ {
  /**
   ...
   */
  constructor(s, e) {
    if (this.data = s, this.isInvalid = !1, !_.IsValid(s)) {
  ...
  uploadLevels(s, e) {
    switch (this.loadType) {
      case _.COMPRESSED_2D:
        this._upload2DCompressedLevels(s, e);
        break;
    }
  }
  _upload2DCompressedLevels(s, e) {
    let i = _.HEADER_LEN + this.bytesOfKeyValueData, r = this.pixelWidth, c = this.pixelHeight;
...
class o {
  ...
  static _Initialize(s) {
    if (o._WorkerPoolPromise || o._DecoderModulePromise)
      return;
    const e = {
      jsDecoderModule: l.GetBabylonScriptURL(this.URLConfig.jsDecoderModule, !0),
      wasmUASTCToASTC: l.GetBabylonScriptURL(this.URLConfig.wasmUASTCToASTC, !0),
      wasmUASTCToBC7: l.GetBabylonScriptURL(this.URLConfig.wasmUASTCToBC7, !0),
      wasmUASTCToRGBA_UNORM: l.GetBabylonScriptURL(this.URLConfig.wasmUASTCToRGBA_UNORM, !0),
      wasmUASTCToRGBA_SRGB: l.GetBabylonScriptURL(this.URLConfig.wasmUASTCToRGBA_SRGB, !0),
      wasmUASTCToR8_UNORM: l.GetBabylonScriptURL(this.URLConfig.wasmUASTCToR8_UNORM, !0),
      wasmUASTCToRG8_UNORM: l.GetBabylonScriptURL(this.URLConfig.wasmUASTCToRG8_UNORM, !0),
      jsMSCTranscoder: l.GetBabylonScriptURL(this.URLConfig.jsMSCTranscoder, !0),
      wasmMSCTranscoder: l.GetBabylonScriptURL(this.URLConfig.wasmMSCTranscoder, !0),
      wasmZSTDDecoder: l.GetBabylonScriptURL(this.URLConfig.wasmZSTDDecoder, !0)
    };
    s && typeof Worker == "function" && typeof URL < "u" ? o._WorkerPoolPromise = new Promise((i) => {
      ...
      i(new A(s, () => y(new Worker(c), void 0, e)));
    }) : typeof o._KTX2DecoderModule > "u" ? o._DecoderModulePromise = l.LoadBabylonScriptAsync(e.jsDecoderModule).then(() => (o._KTX2DecoderModule = KTX2DECODER, o._KTX2DecoderModule.MSCTranscoder.UseFromWorkerThread = !1, o._KTX2DecoderModule.WASMMemoryManager.LoadBinariesFromCurrentThread = !0, p(e, o._KTX2DecoderModule), new o._KTX2DecoderModule.KTX2Decoder())) : (o._KTX2DecoderModule.MSCTranscoder.UseFromWorkerThread = !1, o._KTX2DecoderModule.WASMMemoryManager.LoadBinariesFromCurrentThread = !0, o._DecoderModulePromise = Promise.resolve(new o._KTX2DecoderModule.KTX2Decoder()));
  }
  /**
   * Constructor
  ...
  _uploadAsync(s, e, i) {
    ...
    if (o._WorkerPoolPromise)
      return o._WorkerPoolPromise.then((a) => new Promise((f, R) => {
        a.push((d, h) => {
          const T = (m) => {
    ...
    if (o._DecoderModulePromise)
      return o._DecoderModulePromise.then((a) => (o.DefaultDecoderOptions.isDirty && (o._KTX2DecoderModule.KTX2Decoder.DefaultDecoderOptions = o.DefaultDecoderOptions._getKTX2DecoderOptions()), new Promise((f, R) => {
        a.decode(s, r).then((d) => {
...
class g {
  ...
  loadCubeData(s, e, i, r) {
    ...
    const c = e.getEngine(), a = new _(s, 6), f = a.numberOfMipmapLevels > 1 && e.generateMipMaps;
  ...
  loadData(s, e, i, r) {
    if (_.IsValid(s)) {
      e._invertVScale = !e.invertY;
      const c = new _(s, 1), a = w(c.glInternalFormat);
      ...
      o.IsValid(s) ? new o(e.getEngine())._uploadAsync(s, e, r).then(() => {
