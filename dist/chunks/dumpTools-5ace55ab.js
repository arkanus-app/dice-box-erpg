import { u as I, e as d, E as m, y as S, z as b } from "./index-c6dc4169.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./index-c6dc4169.js").then((r) => r.a0).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-f824e15d.js").then(({ passPixelShader: n }) => {
        if (!e) {
