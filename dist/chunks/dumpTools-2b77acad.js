import { s as I, e as d, E as m, t as S, u as b } from "./index-d880ba66.js";
let l, c = null;
async function x() {
  return c || (c = new Promise((t, s) => {
    ...
    import("./index-d880ba66.js").then((r) => r.a9).then(({ ThinEngine: r }) => {
      var i;
      ...
      const p = new S(e);
      import("./pass.fragment-8b1f64c0.js").then(({ passPixelShader: n }) => {
        if (!e) {
