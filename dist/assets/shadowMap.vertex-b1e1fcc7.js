...
const r = "shadowMapVertexExtraDeclaration", a = `#if SM_NORMALBIAS==1
...
const t = "shadowMapVertexNormalBias", d = `#if SM_NORMALBIAS==1
...
const o = "shadowMapVertexMetric", f = `#if SM_USEDISTANCE==1
...
const i = "shadowMapVertexShader", n = `attribute position: vec3f;
#ifdef NORMAL
...
export {
  v as shadowMapVertexShaderWGSL
};
