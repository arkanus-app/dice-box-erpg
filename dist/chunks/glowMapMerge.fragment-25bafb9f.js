import { r as o } from "./index-f87975a8.js";
const e = "glowMapMergePixelShader", r = `varying vec2 vUV;uniform sampler2D textureSampler;
#ifdef EMISSIVE
...
const l = { name: e, shader: r };
export {
  l as glowMapMergePixelShader
};
