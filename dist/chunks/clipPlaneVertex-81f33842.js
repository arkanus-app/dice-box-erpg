...
const t = "bonesDeclaration", l = `#if NUM_BONE_INFLUENCERS>0
...
#endif
`;
e.IncludesShadersStore[t] || (e.IncludesShadersStore[t] = l);
const V = { name: t, shader: l }, r = "bakedVertexAnimationDeclaration", T = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
const v = { name: r, shader: T }, i = "clipPlaneVertexDeclaration", E = `#ifdef CLIPPLANE
...
#endif
`;
e.IncludesShadersStore[i] || (e.IncludesShadersStore[i] = E);
const _ = { name: i, shader: E }, n = "morphTargetsVertexGlobalDeclaration", x = `#ifdef MORPHTARGETS
...
const U = { name: n, shader: x }, a = "morphTargetsVertexDeclaration", I = `#ifdef MORPHTARGETS
...
const P = { name: a, shader: I }, f = "morphTargetsVertexGlobal", u = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;
e.IncludesShadersStore[f] || (e.IncludesShadersStore[f] = u);
const O = { name: f, shader: u }, d = "morphTargetsVertex", S = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
`;
e.IncludesShadersStore[d] || (e.IncludesShadersStore[d] = S);
const g = { name: d, shader: S }, o = "instancesVertex", N = `#ifdef INSTANCES
...
const M = { name: o, shader: N }, m = "bonesVertex", A = `#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;
e.IncludesShadersStore[m] || (e.IncludesShadersStore[m] = A);
const F = { name: m, shader: A }, s = "bakedVertexAnimation", p = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
const C = { name: s, shader: p }, c = "clipPlaneVertex", R = `#ifdef CLIPPLANE
...
#endif
`;
e.IncludesShadersStore[c] || (e.IncludesShadersStore[c] = R);
const L = { name: c, shader: R };
export {
  v as a,
  V as b,
  P as c,
