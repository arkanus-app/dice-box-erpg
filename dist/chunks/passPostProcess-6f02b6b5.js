import { w as D, l as W, V as r, x as Y, q as S, y as I, v as U, z as k, R as G, F as q, G as B, m as Z, P as H, H as X } from "./index-726652ee.js";
class A {
  constructor(e, a, n, t) {
...
class z {
  ...
  static ConvertCubeMapTextureToSphericalPolynomial(e) {
    ...
    const d = e.readPixels(4, void 0, void 0, !1), g = e.readPixels(5, void 0, void 0, !1), f = e.gammaSpace, V = 5;
    let T = 0;
    return (e.textureType == 1 || e.textureType == 2) && (T = 1), new Promise((E) => {
      Promise.all([t, n, i, s, d, g]).then(([F, m, u, h, p, w]) => {
        ...
        E(this.ConvertCubeMapToSphericalPolynomial(y));
      });
    });
  }
  /**
    ...
    for (let P = 0; P < 6; P++) {
      ...
      for (let h = 0; h < e.size; h++) {
        ...
        for (let w = 0; w < e.size; w++) {
          const y = E.worldAxisForFileX.scale(p).add(E.worldAxisForFileY.scale(m)).add(E.worldAxisForNormal);
          y.normalize();
          ...
          isNaN(l) && (l = 0), isNaN(o) && (o = 0), isNaN(c) && (c = 0), e.type === 0 && (l /= 255, o /= 255, c /= 255), e.gammaSpace && (l = Math.pow(S(l), I), o = Math.pow(S(o), I), c = Math.pow(S(c), I));
...
z.MAX_HDRI_VALUE = 4096;
z.PRESERVE_CLAMPED_COLORS = !1;
class _ extends U {
  _gatherImports(e, a) {
    e ? (this._webGPUReady = !0, a.push(Promise.all([import("./pass.fragment-e1723c1f.js")]))) : a.push(Promise.all([import("./pass.fragment-3adc6846.js")])), super._gatherImports(e, a);
  }
  /**
...
class M extends U {
  _gatherImports(e, a) {
    e ? (this._webGPUReady = !0, a.push(Promise.all([import("./passCube.fragment-2bdd7bb3.js")]))) : a.push(Promise.all([import("./passCube.fragment-68ed359a.js")])), super._gatherImports(e, a);
  }
  /**
...
class b extends H {
  ...
  static _Parse(e, a, n, t) {
    return X.Parse(() => new b(e.name, e.options, a, e.renderTargetSamplingMode, e._engine, e.reusable), e, n, t);
  }
}
G("BABYLON.PassPostProcess", b);
class N extends H {
  /**
   * Gets or sets the cube face to display.
   *  * 0 is +X
   ...
   */
  static _Parse(e, a, n, t) {
    return X.Parse(() => new N(e.name, e.options, a, e.renderTargetSamplingMode, e._engine, e.reusable), e, n, t);
  }
}
q([
  B()
], N.prototype, "face", null);
Z._RescalePostProcessFactory = (R) => new b("rescale", 1, null, 2, R, !1, 0);
export {
  z as C
};
