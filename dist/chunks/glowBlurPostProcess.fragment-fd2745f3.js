import { r as t } from "./index-9624f4fa.js";
const e = "glowBlurPostProcessPixelShader", r = `varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 direction;uniform float blurWidth;float getLuminance(vec3 color)
...
t.ShadersStore[e] || (t.ShadersStore[e] = r);
const i = { name: e, shader: r };
export {
  i as glowBlurPostProcessPixelShader
};
