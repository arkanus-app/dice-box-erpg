import { ax as Me, ay as ye, a1 as b, ap as Y, az as ae, L as B, aA as q, aB as Be, aC as Oe, aD as Le, aE as Ue, aF as De, aG as we, aH as ve, aI as Ne, aJ as Ge, aK as Xe, av as k, aL as Q, aM as Ve, aN as fe, aO as ke, aP as re, aQ as We, V as R, M as ue, aR as he, h as le, Q as oe, g as X, aS as He, T as M, aT as Re, E as te, aU as ze, aV as je, aW as Ye, O, u as qe, W as Ze, aX as Ke, aY as Qe, J as de, aZ as $e, b as K, v as Je, j as L, s as w, a_ as et, a6 as ge, p as pe, G as tt, R as rt } from "./Dice-b8dad4fa.js";
import { B as st, T as j } from "./texture-f572944e.js";
function it(n) {
...
S.prototype.createPrefilteredCubeTexture = function(n, e, t, r, s = null, i = null, a, o = null, h = !0) {
  const l = async (_) => {
    ...
    if (!p)
      return;
    const { DDSTools: m } = await import("./dds-a933ce66.js"), E = [];
    for (let T = 0; T < f; T++) {
...
class Z extends j {
   ...
   */
  isReadyForRendering() {
    this._dumpToolsLoading || (this._dumpToolsLoading = !0, import("./dumpTools-dedff91d.js").then((t) => this._dumpTools = t)), this._objectRenderer.prepareRenderList(), this.onBeforeBindObservable.notifyObservers(this), this._objectRenderer.initRender(this.getRenderWidth(), this.getRenderHeight());
...
`) : this.options.defines;
  ...
  _gatherImports(e = !1, t) {
    this.options.useAsPostProcess && (e && this._webGPUReady ? t.push(Promise.all([import("./postprocess.vertex-5c1d343d.js")])) : t.push(Promise.all([Promise.resolve().then(() => Ie)])));
  }
  /** @internal */
...
`) : P.defines ?? null, u = P.textureType ?? 0, f = P.vertexUrl ?? "postprocess", c = P.indexParameters, p = P.blockCompilation ?? !1, m = P.textureFormat ?? 5, E = P.shaderLanguage ?? 0, I = P.uniformBuffers ?? null, T = P.extraInitializations, F = P.effectWrapper;
  ...
  _gatherImports(e = !1, t) {
    e && this._webGPUReady ? t.push(Promise.all([import("./postprocess.vertex-5c1d343d.js")])) : t.push(Promise.all([Promise.resolve().then(() => Ie)]));
  }
  /**
   * Gets a string identifying the name of the class
